...
{
    printk(KERN_INFO "myv4l2: VIDIOC_ENUM_FMT called, index=%d\n", f->index);
    if (f->index != 0)
        return -EINVAL;
...
static int vidioc_try_fmt_vid_cap(struct file *file, void *priv, struct v4l2_format *f)
{
    ...
    printk(KERN_INFO "myv4l2: VIDIOC_TRY_FMT called\n");
    return 0;
}

static int vidioc_g_fmt_vid_cap(struct file *file, void *priv, struct v4l2_format *f)
{
    printk(KERN_INFO "myv4l2: VIDIOC_G_FMT called\n");
...
static int vidioc_s_fmt_vid_cap(struct file *file, void *priv, struct v4l2_format *f)
{
    ...
    printk(KERN_INFO "myv4l2: VIDIOC_S_FMT called\n");
...
MODULE_DESCRIPTION("Day 9 - pixel format negotiation (YUYV)");
